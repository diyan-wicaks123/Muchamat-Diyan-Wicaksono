...
Iya.addEventListener("click", function () {
    ...
    if (Iya.value == 1) {
        ...
        Text.innerHTML = "Halo ini saya Muchamat Diyan Wicaksono";
        ...
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        Text.innerHTML = "Semoga Allah menerima amal baik kita,<br>memaafkan kesalahan kita,<br>dan menjadikan kita pribadi yang lebih baik.";
        Text.classList.add('text-animate');
    }else if(Iya.value == 9){
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
